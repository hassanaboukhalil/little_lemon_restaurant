          ...
          <div className="div-items">
            {/* {cart.data ? 
                        ...
                        <div className='cart-item'>
                          ...
                          <div className='amount-and-remove'>
                            <div className='add-remove'>
                              <button className='minus-btn' onClick={() => dispatch(cartActions.minusItem({ name: item.name }))}>-</button>
                              <span>{item.amount}</span>
                              <button className='plus-btn' onClick={() => dispatch(cartActions.plusItem({ name: item.name }))}>+</button>
                            </div>
                            <button className='remove-btn' onClick={() => dispatch(cartActions.removeItem({ name: item.name }))}>Remove</button>
                          </div>
                        </div>
                      ))}
                    </>
                    ...
                    >
                      ...
                      <path d="M202.17653,781.16927c22.43841,13.49969,31.08016,40.3138,31.08016,40.3138s-27.73812,4.92679-50.17653-8.57291S152,772.59636,152,772.59636,179.73811,767.66958,202.17653,781.16927Z" transform="translate(-152 -76.01429)" fill="#f4ce14"/>
                      <rect x="413.2485" y="35.90779" width="140" height="2" fill="#f2f2f2"/><rect x="513.2485" y="37.40779" width="2" height="18.5" fill="#f2f2f2"/><rect x="452.2485" y="37.40779" width="2" height="18.5" fill="#f2f2f2"/>
                      ...
                      <circle cx="156.78851" cy="726.03301" r="17.88673" fill="#3f3d56"/><circle cx="333.10053" cy="726.03301" r="17.88673" fill="#3f3d56"/>
                    ...
                    <div className="amount-and-remove">
                      <div className="add-remove">
                        <button
                          className="minus-btn"
                          onClick={() =>
                            dispatch(cartActions.minusItem({ name: item.name }))
                          }
                        >
                          -
                        </button>
                        ...
                        <button
                          className="plus-btn"
                          onClick={() =>
                            dispatch(cartActions.plusItem({ name: item.name }))
                          }
                        >
                          +
                        </button>
                      ...
                      <button
                        ...
                        onClick={() =>
                          dispatch(cartActions.removeItem({ name: item.name }))
                        }
                      >
                        Remove
                      </button>
                ...
                <form className="promocode-form">
                  <FormControl className="promocode-input" role="group">
                    <Input
                      ...
                      aria-label="Enter the promocode"
                      required
                    />
                  </FormControl>
                  <Button
