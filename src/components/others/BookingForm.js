import { Button, FormControl, FormErrorMessage, FormLabel, Input, Select, Heading, Stack, Text, Step, StepIcon, StepIndicator, StepSeparator, StepStatus, Stepper, useSteps, } from '@chakra-ui/react'
                ...
                <form className='booking-form' onSubmit={handle_submit}>
                    {
                        ...
                        <>
                            ...
                            <Button type="submit" w="100%" bg="#7f5ad5" color="white" isLoading={false} aria-label="On Click">
                                Submit
                            </Button>
                        </>
                        :
                        <>
                            ...
                            </Stack>
                            {
                                ...
                                <>
                                    ...
                                    <Button type="submit" w="100%" bg="#7f5ad5" color="white" isDisabled={(formik.errors.firstName || formik.errors.lastName || formik.errors.email) ? true : false} isLoading={false} aria-label="On Click">
                                        Submit
                                    </Button>
                                </>
                            }
